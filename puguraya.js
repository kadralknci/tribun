...
$(document).ready(function() {
    ...
    if ($('.header__bottom .menu-slide a.active').length) {
...
$(window).bind('scroll', function() {
	var blbHeight = $('#billboard').outerHeight();
	var qcbHeight = $('.quickcb').outerHeight();
	var megaHeight = $(".mega_bb").outerHeight();
	var smbHeight = $(".smartbanner_new").outerHeight();
	var uniHeight = qcbHeight+megaHeight+smbHeight+blbHeight;
	...
	// else if($('.top_banner').length > 0){
	// 	if ($(this).scrollTop() >= 100) {
	// 		$('#billboard').addClass('rel');
	// 	}
	// 	else if ($(this).scrollTop() >= 100 + tbHeight) {
	// 		$('.backtop').addClass('show');
	//         $('.header__top, .menu__block').addClass('fixed');
	// 	}
	// 		else{
...
// $( document ).ready(function() {
//         if ($(window).width() < 768) {
//                $('.lvr_info').fadeIn("slow").css("display", "inline-block");
//                setTimeout(function() {
//                 $('.lvr_info').fadeOut("slow").hide();
//             }, 10000);
//         } else {
//             $('.lvr_info').css("display", "none");
//         }
//     });
...
//     $( ".lvrke_t" ).click(function() {
//         $( ".lvr_ke" ).toggleClass( 'lvr_kdrop');
//     });
